...
assigned: 2025-04-16 11:00:00.00-7
due: 2025-04-21 23:59:59.59-7
---
...
It may be a good idea to read up on some concepts we’ll be using in this lab before you get started, specifically **Chapter 1.4.6.2 (Inheritance)** ([electronic chapter 1.13.2. Inheritance](https://runestone.academy/ns/books/published/pythonds/Introduction/ObjectOrientedProgramminginPythonDefiningClasses.html#inheritance-logic-gates-and-circuits)).
