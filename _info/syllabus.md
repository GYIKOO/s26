---
title: "Syllabus, CMPSC 9, Spring 2026"
layout: default
ready: true
---

# CMPSC 9 Syllabus (Spring 2026)

Basic Facts
-----------

* **Course Web Site**: <https://ucsb-cs9.github.io/s26/>
* **Instructor**: Prof Kate (Dr. Yekaterina Kharitonova)
* **Lecture**: Mon Wed 3:30pm - 4:45pm (HFH 1104)
* **Lab** (50 minute lab sections): Thursdays in SSMS 1301 - check GOLD to see your assigned section time and location (if you cannot make it to your assigned section time, you are allowed to attend another section)

* **TAs**:  {{site.ta_list_full}} (contact via EdStem)
* **Mentors**: {{site.mentors_list}} (contact via EdStem)

* **Office Hours**: See <https://ucsb-cs9.github.io/s26/info/office_hours/>
...
* I recognize that some absences (e.g., minor illnesses, mishaps, etc.) are unavoidable, so we will drop the lowest two grades from everyone's homework. No lab assignments will be dropped. This way, absences (or failure to submit homework) does not unduly penalize your grade unless it becomes excessive.
...
Please **refrain from emailing me or the course staff directly**. Using the forum allows the class and the staff team to be on the same page; when you are posting privately on the forum, the instructor as well as the mentors are all able to see your post.
...
Letter grades will be determined by the end of the course after all labs, homeworks, and exams have been computed. The grade will include the + and - scale (90% = A-, 89% = B+, etc.). However, we will adjust the letter grades accordingly based on the class' overall performance at the end of the course. If you are concerned about your grade in the class, I encourage you to discuss the matter with me during my office hours, ideally **before Week 7**. Please come talk to me sooner rather than later, so there can be some time where we can help you succeed in the course.
...
Attendance and active participation are not mandatory and are not part of the official course grade breakdown; however, we might use your scores from the lab attendance and/or in-class activities (e.g., iClicker participation) to round up your grade at the end of the quarter.
...
* UCSB has a variety of resources for [students facing food insecurity](https://food.ucsb.edu/).
  - If you need a loaner laptop, you can always get a Chromebook from Food and Basic Needs Advising opposite the campus store. You can borrow laptops for 30 days (for free!): “Short Term Loaner Laptop Devices” <https://food.ucsb.edu/resources/technology-resources>. They have other devices available for students to use as well.
